...
public class UIInit extends JFrame {
    ...
    public void initUI() {
        ...
        dtInicialTextField.setText(new SimpleDateFormat("dd/MM/yyyy").format(new Date(System.currentTimeMillis())));
        ...
        dtFinalTextField.setText(new SimpleDateFormat("dd/MM/yyyy").format(new Date(System.currentTimeMillis())));
